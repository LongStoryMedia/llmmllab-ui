...
function tokenizeBlankLine(effects, ok2, nok) {
  ...
  function after(code3) {
    return code3 === codes.eof || markdownLineEnding(code3) ? ok2(code3) : nok(code3);
  }
}
...
function tokenizeFurtherStart(effects, ok2, nok) {
  ...
  function afterPrefix(code3) {
    const tail = self.events[self.events.length - 1];
    return tail && tail[1].type === types.linePrefix && tail[2].sliceSerialize(tail[1], true).length >= constants.tabSize ? ok2(code3) : markdownLineEnding(code3) ? furtherStart2(code3) : nok(code3);
  }
}
...
function tokenizeLabelStartImage(effects, ok2, nok) {
  ...
  function after(code3) {
    return code3 === codes.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code3) : ok2(code3);
  }
}
...
function tokenizeIndent(effects, ok2, nok) {
  ...
  function afterPrefix(code3) {
    ok(self.containerState, "expected state");
    const tail = self.events[self.events.length - 1];
    return tail && tail[1].type === types.listItemIndent && tail[2].sliceSerialize(tail[1], true).length === self.containerState.size ? ok2(code3) : nok(code3);
  }
}
...
//# sourceMappingURL=chunk-GAYUABSX.js.map
